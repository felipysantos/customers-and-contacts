...
const loginClientService = ({ email, password }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const comparePassword = yield bcrypt.compare(password, clientSearch.password);
    if (!comparePassword) {
        throw new Error("Email or password incorrect");
    }
